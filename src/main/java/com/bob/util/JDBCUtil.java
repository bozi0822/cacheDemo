...
public class JDBCUtil {
    ...
    public static Connection getConnection() {
        try {
            ...
            url = "jdbc:mysql://" + ip + ":" + port + "/" + mysqldatabase + "?characterEncoding=utf-8&serverTimezone=UTC&useSSL=false";
